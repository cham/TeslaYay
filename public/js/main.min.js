...
window.videoEmbedder=function(){"use strict";function e(e){["type","url","id"].forEach(function(t){if(!e[t])throw new Error(t+" required")})}function t(e){var t=e.match(/\?t=([0-9]*m)?([0-9]*s)?$/);if(!t||3!==t.length)return 0;var n=parseInt(t[1],10)||0,r=parseInt(t[2],10)||0;return 60*n+r}function n(e){var t=document.createElement("img");return t.src="//img.youtube.com/vi/"+e+"/0.jpg",t.className="youtube_placeholder",t.title="Click to play this video",t}function r(e){var t=document.createElement("div");return t.className="youtube_playbutton",t.dataset.uniqueId=e,t}function i(e,t,i){var a=document.createElement("div");return a.className="youtube_wrapper",a.appendChild(n(e)),a.appendChild(r(i)),a}function a(e,t,n,r){var i=document.createElement("iframe");return i.width=t,i.height=n,i.src="https://www.youtube.com/embed/"+e+"?rel=&amp;showinfo=0&amp;start="+r,i.frameborder=0,i.allowfullscreen=!0,i}function u(){var e=document.createElement("div");return e.className="embed-wrapper",e}function o(t){e(t||{}),this.id=t.id,this.uniqueId=t.id+l.length,this.url=t.url,this.el=u()}function d(e,t){var n=new o({url:e,id:t,type:"youtube"});return n.render(),l.push(n),n.el.innerHTML}function s(e){e.addEventListener("click",function(e){e.target.className&&e.target.className.indexOf("youtube_playbutton")>-1&&l.forEach(function(t){if(t.uniqueId===e.target.dataset.uniqueId){var n=e.target.parentNode,r=n.getElementsByTagName("img")[0],i=r.offsetWidth,a=r.offsetHeight;n.appendChild(t.el),e.target.style.display="none",r.style.display="none",t.renderVideo(i,a)}})});var t=Date.now(),n=200;window.addEventListener("resize",function(){Date.now()-t<n||(l.forEach(function(e){var t=e.el.getElementsByTagName("iframe")[0],n=.75;t&&(t.height=n*t.offsetWidth)}),t=Date.now())})}if(!document.body.addEventListener)return{};o.prototype.render=function(){this.el.innerHTML="",this.el.appendChild(i(this.id,this.url,this.uniqueId))},o.prototype.renderVideo=function(e,n){this.el.innerHTML="",this.el.appendChild(a(this.id,e,n,t(this.url)))};var l=[];return s(document.body),{embedYoutube:d}}();