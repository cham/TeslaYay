...
function cloneObj(e){return jQuery.extend(!0,{},e)}function responsiveEmbed(e){return['<div class="embed-container">',e,"</div>"].join("")}function format_special(e){var t=new RegExp('(?:")?http(?:s)?://(?:www.)?youtu(?:be)?.(?:[a-z]){2,3}(?:[a-z/?=]+)([a-zA-Z0-9-_]{11})(?:[a-z0-9?&-_=]+)?'),n=new RegExp("http(?:s)?://(?:www.)?vimeo.com/([0-9]+)(?:#[a-z0-9?&-_=]*)?");$(e).each(function(){$(this).find("*").andSelf().contents().each(function(){if(3===this.nodeType&&"A"!==this.parentNode.nodeName){var e=this.textContent;e=e.replace(t,function(e,t){var n=e.substring(e.indexOf("?")+1).split("&"),a=425,o=349,i=[],c="";$.each(n,function(e,t){var n=t.split("=");if("t"==n[0]&&i.push("t="+n[1]),"size"==n[0]){var c=n[1].split("x");a=c[0],o=c[1]}});for(var r=0;r<i.length;r++)c+="#",c+=i[r];var l;return l=-1!=e.indexOf('"')?e:"<div id='"+t+"' class='youtube_wrapper' data-extra='"+c+"'></div><br/>"}),e=e.replace(n,function(e,t){return-1!=e.indexOf('"')?e:responsiveEmbed('<iframe src="http://player.vimeo.com/video/'+t+'?title=0&amp;byline=0&amp;portrait=0"frameborder="0" webkitAllowFullScreen allowFullScreen></iframe><br />')}),e!==this.textContent&&$("#toggle-html").data("active")&&$(this).replaceWith(e)}});$(this).find("blockquote").reverse().each(function(){var e=$(this).attr("title")||"Someone";$(this).prepend('<div class="tqname">'+e+" said:</div>").addClass("tquote")}),$(this).find(".youtube_wrapper").each(function(){var e=this;$.ajax({url:"http://gdata.youtube.com/feeds/api/videos/"+$(this).attr("id")+"?v=2&alt=jsonc",dataType:"jsonp",success:function(t){$(e).append('<img src="'+t.data.thumbnail.hqDefault+'" class="youtube_placeholder" title="Click to play this video" /><h2>'+t.data.title+'</h2><div class="youtube_playbutton"></div>')}})})}),Autolinker&&Array.apply(null,document.querySelectorAll(".content")).forEach(function(e){e.querySelector(".youtube_wrapper")||(e.innerHTML=Autolinker.link(e.innerHTML))}),$("spoiler").each(function(){var e="Warning! May contain spoilers. Click to reveal.",t=$('<div class="spoiler"></div>'),n=$('<div class="spoiler-disclaimer"></div>').text(e),a=$('<div class="spoiler-content"></div>').html($(this).html());t.append(n).append(a).click(function(){n.toggle(),a.toggleClass("spoiled")}),$(this).replaceWith(t)})}function insertAtCaret(e,t){var n,a,o,i=document.getElementById(e),c=i.scrollTop,r=0,l=i.selectionStart||"0"==i.selectionStart?"ff":document.selection?"ie":!1;"ie"==l?(i.focus(),o=document.selection.createRange(),n=o.text,o.moveStart("character",-i.value.length),r=o.text.length):"ff"==l&&(r=i.selectionStart,n=i.value.substring(r,i.selectionEnd));var s=t.indexOf('"');-1!=s||n||(s=t.indexOf("<",1)-1),s=-1==s?0:t.length-s-1;var d=t.indexOf("<",1);-1==d?a=0:(t=t.substring(0,d)+n+t.substring(d),s&&(s+=n.length),a=n.length);var u=i.value.substring(0,r),m=i.value.substring(r+a);i.value=u+t+m,r=r+t.length-s,"ie"==l?(i.focus(),o=document.selection.createRange(),o.moveStart("character",-i.value.length),o.moveStart("character",r),o.moveEnd("character",0),o.select()):"ff"==l&&(i.selectionStart=r,i.selectionEnd=r,i.focus()),i.scrollTop=c}jQuery.fn.reverse=function(){return this.pushStack(this.get().reverse(),arguments)},$.fn.selectRange=function(e,t){return t||(t=e),this.each(function(){if(this.setSelectionRange)this.focus(),this.setSelectionRange(e,t);else if(this.createTextRange){var n=this.createTextRange();n.collapse(!0),n.moveEnd("character",t),n.moveStart("character",e),n.select()}})},$(document).ready(function(){format_special(".comment .content, .recent-post-content")}),$("#thread-content-input").pasteImageReader(function(e){var t=$(this);t.parent().find(".error").remove(),t.after('<p class="loading">Uploading image...</p>'),$.ajax({method:"post",url:"/pasteimagedata",data:{dataURL:e.dataURL},success:function(n){t.parent().find(".error,.loading").fadeOut(),t.val(t.val()+' <img src="'+n.filepath+'" width="'+e.width+'" height="'+e.height+'">')},error:function(e){413===e.status&&(t.parent().find(".error,.loading").remove(),t.after('<p class="error">Image too large, maximum file size for pasted images is 2MB</p>'))}})}),document.getElementById("thread-content-input")&&document.getElementById("thread-content-input").addEventListener("drop",function(e){e.preventDefault();var t=e.dataTransfer.files[0],n=new FileReader,a=$("#thread-content-input");n.onload=function(e){var t=document.createElement("img");t.onload=function(){$.ajax({method:"post",url:"/pasteimagedata",data:{dataURL:e.target.result},success:function(e){a.parent().find(".error,.loading").fadeOut(),a.val(a.val()+' <img src="'+e.filepath+'" width="'+t.naturalWidth+'" height="'+t.naturalHeight+'">')},error:function(e){413===e.status&&(a.parent().find(".error,.loading").remove(),a.after('<p class="error">Image too large, maximum file size for pasted images is 2MB</p>'))}})},t.src=e.target.result},n.readAsDataURL(t)},!1),$("#preview-button").on("click",function(e){e.preventDefault();var t=$("#thread-content-input").val();$.post("/ajax/preview",{content:t}).then(function(e){$("#comment-preview .content").html(e.content),format_special("#comment-preview .content"),$("#comment-preview").show()})}),$("#comment-form").on("submit",function(){return 0===$("#thread-content-input").val().length?!1:($("#submit-button").attr("disabled","disabled"),void this.submit())}),selected={html:null,comment_id:null},$(".content").click(function(){if(selected.html=null,selected.comment_id=null,window.getSelection){if(selObj=window.getSelection(),selObj.focusNode){for(selRange=selObj.getRangeAt(0),p=selRange.commonAncestorContainer;p.parentNode&&!$(p).hasClass("comment-container");)p=p.parentNode;p.id&&(dash=p.id.lastIndexOf("-"),-1!=dash&&(selected.comment_id=p.id.substring(dash+1),fragment=selRange.cloneContents(),e=document.createElement("b"),e.appendChild(fragment),selected.html=e.innerHTML))}}else document.selection&&document.selection.createRange&&"None"!=document.selection.type&&(selected.html=document.selection.createRange().htmlText)}),$(".content .censor").click(function(){$(this).children(".content").toggle()}),thread={status_text:{nsfw:["Unmark Naughty","Mark Naughty"],closed:["Open Thread","Close Thread"]},comments:[],get_comment_details:function(e,t){var n=$("#comment-"+e+" .content"),a=$("#comment-"+e+" .username a").text(),o=$(".welcome a:first").text();$.ajax({method:"get",url:"/comment/"+e,success:function(i){i&&i.content&&(thread.comments[e]={container:n,rendered:n.html(),data:{content:i.content.replace(/<br>/g,"\n").replace(/<br \/>/g,"\n"),owner:i.postedby===o&&1===$("#comment-"+e+" #thread-control").length||moment(i.created).diff(new Date)>-36e5},author:a},t())}})},quote:function(e){void 0!==thread.comments[e]?(content=selected.comment_id&&selected.comment_id!=e||!selected.html?thread.comments[e].data.content:selected.html,selected.html=null,selected.comment_id=null,html='<blockquote title="'+$.trim(thread.comments[e].author)+'">'+content+"</blockquote>",$("#thread-content-input").val($("#thread-content-input").val()+html),$(window).scrollTop($("#thread-content-input").offset().top),$("#thread-content-input").focus(),$("#thread-content-input").scrollTop($("#thread-content-input")[0].scrollHeight-$("#thread-content-input").height()),$("#thread-content-input").selectRange($("#thread-content-input").val().length)):thread.get_comment_details(e,function(){thread.quote(e)})},save:function(e){var t={comment_id:e,content:$("#comment-"+e+" .content textarea").val(),isFirst:1===$("#comment-"+e+" .user-block").length};$.ajax({method:"put",url:"/comment/"+e,data:t,success:function(t){var n=t.content;Math.floor(t.edit_percent)>0&&(n+='<div class="edited-percent">Edited '+Math.floor(t.edit_percent)+"%</div>"),format_special($("#comment-"+e+" .content").html(n)),delete thread.comments[t._id]}})},set_status:function(e,t,n,a){$.get("/ajax/set_thread_status/"+e+"/"+t+"/"+n+"/"+a,function(o){if(1===o){if("deleted"==t)return void(window.location="/");n=1==n?0:1,$("#control-"+t+" span").unbind("click").bind("click",function(){return thread.set_status(e,t,n,a),!1}).html(thread.status_text[t][n])}})},view_original:function(e){void 0!==thread.comments[e]&&$("#comment-"+e+" .content").html(thread.comments[e].rendered)},view_source:function(e){if(void 0!==thread.comments[e]){if(comment=thread.comments[e],0!==comment.container.find("textarea").length)return void thread.view_original(e);comment.container.html($("<textarea>",{id:"comment-"+e+"-source",val:comment.data.content})),comment.data.owner&&comment.container.append($("<button>",{html:"Save"}).bind("click",function(){thread.save(e)})),comment.container.append($("<button>",{html:"Close"}).bind("click",function(){thread.view_original(e)}))}else thread.get_comment_details(e,function(){thread.view_source(e)})},id:function(){return $(".favourite").attr("rel")}},$("#control-closed").click(function(){var e=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+e+"/close",success:function(){window.location.reload()}})}),$("#control-open").click(function(){var e=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+e+"/open",success:function(){window.location.reload()}})}),$("body").on("click","#control-nsfw",function(){var e=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+e+"/nsfw",success:function(){$("#control-nsfw").attr("id","control-sfw").find("span").text("Unmark Naughty")}})}),$("body").on("click","#control-sfw",function(){var e=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+e+"/sfw",success:function(){$("#control-sfw").attr("id","control-nsfw").find("span").text("Mark Naughty")}})}),function(){var e,t=$("input[name=threadurlname]").val(),n=$("#notifications"),a=0;t&&n.length&&(e=new EventSource("/thread/"+t+"/events"),n.on("click","#closenotify",function(e){e.preventDefault(),n.hide()}).on("click","#notify",function(e){e.preventDefault(),window.location.hash="#bottom",window.location.reload(!0)}),e.addEventListener("message",function(){a++,n.html('<a id="closenotify"></a><div id="notifier"><a id="notify" href="">'+a+" new post"+(1===a?"":"s")+" added</a></div>").show()},!1))}();
function NestedQuote(t){this.$node=t,this.labels={up:"Show older",down:"Hide"},this.doNesting()}NestedQuote.prototype.doNesting=function(){var t=this.$node.find(".tquote:first");t.length&&this.applyNesting(t)},NestedQuote.prototype.makeToggle=function(t){var e=$('<a href="#" class="quote-nested-toggle"></a>').text(this.labels.up),i=this.labels;return e.click(function(n){n.preventDefault(),t.is(":hidden")?(e.text(i.down),t.show()):(e.text(i.up),t.hide())}),e},NestedQuote.prototype.skipToggle=function(t){var e=t.clone(),i=this.$node.clone();return e.add(i).find(".tqname").remove(),e.add(i).find("img").each(function(){var t=$(this);t.before("<span>"+t.attr("href")+"</span>")}),e.text()===i.text()},NestedQuote.prototype.applyNesting=function(t){if(t){if(this.skipToggle(t))return this.applyNesting(t.find(".tquote:first"));t.before(this.makeToggle(t)),t.hide()}},$(".welcome a:first").length&&$(".you").html($("<div>").append($(".welcome a:first").clone()).html()),$(function(){function t(){return"undefined"==typeof window.thread?!1:!0}function e(){var t,e=["input","textarea","button"],i=[{seq:[113,116],path:"/"},{seq:[113,112],path:"/f/participated"},{seq:[113,102],path:"/f/favorites"},{seq:[113,104],path:"/f/hidden"},{seq:[113,109],path:"/messages/inbox"},{seq:[113,117],path:"/users"}],n=[];return function(a){-1===e.indexOf(a.target.nodeName.toLowerCase())&&(n.push(a.which),n=n.slice(-2),t=_(i).find(function(t){return _(t.seq).isEqual(n)}),t&&(self.location=t.path))}}function i(t,e,i){window.location.href=t+"?x="+e+"&y="+i}var n,a=$("#title-input").html();$("#main-title.changeling").bind("click",function(){if($(this).is(":not(.editing)")){n=$.trim($("h3",this).text()),$(this).addClass("editing"),$("h3",this).empty().append(a);var t=$(this).find("#title-input");t.val(n),t[0].focus(),t[0].select()}}),$(".youtube_wrapper").on("click",function(){var t=$(this);t.data("active")||(t.data("active",!0),$(this).html('<div class="embed-container"><iframe src="http://www.youtube.com/embed/'+t.attr("id")+"?autoplay=1"+t.data("extra")+'" frameborder="0" allowfullscreen></iframe></div><br />'))}),$("body").on("click","#cancel-title",function(){$("h3","#main-title").empty().text(n),$("#main-title").removeClass("editing")}),$("body").on("click","#save-title",function(){var e=$("#title-input").val(),i="title="+encodeURIComponent(e);i+=t()?"&thread_id="+thread.id():"",$.ajax({type:"POST",url:"/title/edit",data:i,success:function(){$("h3","#main-title").empty().text(e),$("#main-title").removeClass("editing")}})}),$("#toggle-html").bind("click",function(){$.ajax({method:"put",url:"/togglehtml",success:function(){window.location.reload(!0)}})}),$(".hide-thread").bind("click",function(t){t.preventDefault(),t.stopPropagation();var e=$(this),i=e.hasClass("added"),n=e.attr("href"),a=e.data("id");$.ajax({method:"put",url:n,data:{threadid:a},success:function(){e.toggleClass("added",!i),e.parent(".five").parent(".thread").slideUp().next().slideUp()}})}),$(".favourite").bind("click",function(t){t.preventDefault(),t.stopPropagation();var e=$(this),i=e.attr("href"),n=e.data("id");$.ajax({method:"put",url:i,data:{threadid:n},success:function(){e.toggleClass("added")}})});var o=$("#login-box").html();$("#login-form").on("submit",function(t){t.preventDefault();var e={username:$("#username").val(),password:$("#password").val()};$.ajax({url:"/login",type:"POST",data:e}).fail(function(t){$(".error").text(401===t.status?"Login incorrect":403===t.status?"Account banned":"Unknown error")}).then(function(){window.location.reload()})}),$("#forgot-password").on("click",function(t){t.preventDefault(),$("#login-box").load("/auth/forgot_password")}),$("#forgot-request").on("submit",function(t){t.preventDefault();var e={email:$("#forgot-email").val(),key:$("#forgot-key").val()};$.ajax({url:"/auth/forgot_password",type:"POST",data:e}).fail(function(t){$(".error").text(JSON.parse(t.responseText).error)}).then(function(){$("#login-box").html(o),$(".error").text("Password reset email sent")})}),$("#forgot-back").on("click",function(t){t.preventDefault(),$("#login-box").html(o)}),$("#hide-ads").on("click",function(t){t.preventDefault(),$.ajax({url:"/ajax/hide_ads/"+session_id,success:function(t){1==t&&window.location.reload(!1)}})}),$("#unhide-ads").on("click",function(t){t.preventDefault(),$.ajax({url:"/ajax/show_ads/"+session_id,success:function(t){1==t&&window.location.reload(!1)}})}),$(".remove-acq, .toggle-acq").click(function(t){t.preventDefault();var e=$(this),i=$(this).parent(),n=$(this).attr("rel"),a=["ignore","buddy"],o=i.filter(".buddy-listing").length,s=e.hasClass("toggle-acq"),r=a[o];$.ajax({method:"post",url:"/buddies",data:{command:r,username:n,remove:!0},success:function(){var t=i.detach();s&&(r=a[1-o],$.ajax({method:"post",url:"/buddies",data:{command:r,username:n},success:function(){return"ignore"===r?(t.removeClass("buddy-listing").addClass("enemy-listing"),t.find(".toggle-acq").text("buddilize"),$("#enemy-listings").append(t)):(t.removeClass("enemy-listing").addClass("buddy-listing"),t.find(".toggle-acq").text("ignore"),void $("#buddy-listings").append(t))}}))}})});var s=$(".give-point, .take-point");s.click(function(t){var e=$(this),i=e.parent().find(".current-points"),n="minus"===e.data("type")?"removepoint":"addpoint",a=e.data("commentid");t.preventDefault(),$.ajax({method:"put",url:"/comment/"+a+"/"+n,success:function(t){var e=t.points;s.css({visibility:"hidden"}),i.text(e+" point"+(1!==e?"s":""))},error:function(t){return 401===t.status?(s.css({visibility:"hidden"}),i.text("Unauth")):void i.text("Error")}})}),$("body").keypress(e());var r=$(".content > .tquote > .tquote");if(r.each(function(){new NestedQuote($(this))}),$(".buddyform").each(function(){$(this)}),$("#search-box").submit(function(t){$("#search-phrase").val().trim().length||t.preventDefault()}),$(".amazing-game").length){var d=parseInt($(".position-x").val(),10),l=parseInt($(".position-y").val(),10),c=window.location.href.split("?")[0];$(".go-north").click(function(){i(c,d,l-1)}),$(".go-south").click(function(){i(c,d,l+1)}),$(".go-west").click(function(){i(c,d-1,l)}),$(".go-east").click(function(){i(c,d+1,l)})}});
