...
function cloneObj(t){return jQuery.extend(!0,{},t)}function responsiveEmbed(t){return['<div class="embed-container">',t,"</div>"].join("")}function format_special(t){var e=new RegExp('(?:")?http(?:s)?://(?:www.)?youtu(?:be)?.(?:[a-z]){2,3}(?:[a-z/?=]+)([a-zA-Z0-9-_]{11})(?:[a-z0-9?&-_=]+)?'),n=new RegExp("http(?:s)?://(?:www.)?vimeo.com/([0-9]+)(?:#[a-z0-9?&-_=]*)?");$(t).each(function(){$(this).find("*").andSelf().contents().each(function(){if(3===this.nodeType&&"A"!==this.parentNode.nodeName){var t=this.textContent;t=t.replace(e,function(t,e){var n=t.substring(t.indexOf("?")+1).split("&"),a=425,o=349,i=[],r="";$.each(n,function(t,e){var n=e.split("=");if("t"==n[0]&&i.push("t="+n[1]),"size"==n[0]){var r=n[1].split("x");a=r[0],o=r[1]}});for(var c=0;c<i.length;c++)r+="#",r+=i[c];var l;return l=-1!=t.indexOf('"')?t:"<div id='"+e+"' class='youtube_wrapper' data-extra='"+r+"'></div><br/>"}),t=t.replace(n,function(t,e){return-1!=t.indexOf('"')?t:responsiveEmbed('<iframe src="http://player.vimeo.com/video/'+e+'?title=0&amp;byline=0&amp;portrait=0"frameborder="0" webkitAllowFullScreen allowFullScreen></iframe><br />')}),t!==this.textContent&&$("#toggle-html").data("active")&&$(this).replaceWith(t)}});$(this).find("blockquote").reverse().each(function(){var t=$(this).attr("title")||"Someone";$(this).prepend('<div class="tqname">'+t+" said:</div>").addClass("tquote")}),$(this).find(".youtube_wrapper").each(function(){var t=this;$.ajax({url:"http://gdata.youtube.com/feeds/api/videos/"+$(this).attr("id")+"?v=2&alt=jsonc",dataType:"jsonp",success:function(e){e.data&&e.data.thumbnail&&$(t).append('<img src="'+e.data.thumbnail.hqDefault+'" class="youtube_placeholder" title="Click to play this video" /><h2>'+e.data.title+'</h2><div class="youtube_playbutton"></div>')}})})}),window.Autolinker&&$(".content").each(function(){$(this).find(".youtube_wrapper").length||(this.innerHTML=Autolinker.link(this.innerHTML))}),$("spoiler").each(function(){var t="Warning! May contain spoilers. Click to reveal.",e=$('<div class="spoiler"></div>'),n=$('<div class="spoiler-disclaimer"></div>').text(t),a=$('<div class="spoiler-content"></div>').html($(this).html());e.append(n).append(a).click(function(){n.toggle(),a.toggleClass("spoiled")}),$(this).replaceWith(e)})}function insertAtCaret(t,e){var n,a,o,i=document.getElementById(t),r=i.scrollTop,c=0,l=i.selectionStart||"0"==i.selectionStart?"ff":document.selection?"ie":!1;"ie"==l?(i.focus(),o=document.selection.createRange(),n=o.text,o.moveStart("character",-i.value.length),c=o.text.length):"ff"==l&&(c=i.selectionStart,n=i.value.substring(c,i.selectionEnd));var s=e.indexOf('"');-1!=s||n||(s=e.indexOf("<",1)-1),s=-1==s?0:e.length-s-1;var d=e.indexOf("<",1);-1==d?a=0:(e=e.substring(0,d)+n+e.substring(d),s&&(s+=n.length),a=n.length);var u=i.value.substring(0,c),m=i.value.substring(c+a);i.value=u+e+m,c=c+e.length-s,"ie"==l?(i.focus(),o=document.selection.createRange(),o.moveStart("character",-i.value.length),o.moveStart("character",c),o.moveEnd("character",0),o.select()):"ff"==l&&(i.selectionStart=c,i.selectionEnd=c,i.focus()),i.scrollTop=r}jQuery.fn.reverse=function(){return this.pushStack(this.get().reverse(),arguments)},$.fn.selectRange=function(t,e){return e||(e=t),this.each(function(){if(this.setSelectionRange)this.focus(),this.setSelectionRange(t,e);else if(this.createTextRange){var n=this.createTextRange();n.collapse(!0),n.moveEnd("character",e),n.moveStart("character",t),n.select()}})},jQuery.valHooks.textarea={get:function(t){return t.value.replace(/\r?\n/g,"\r\n")}},$(document).ready(function(){format_special(".comment .content, .recent-post-content")}),$("#thread-content-input").pasteImageReader(function(t){var e=$(this);e.parent().find(".error").remove(),e.after('<p class="loading">Uploading image...</p>'),$.ajax({method:"post",url:"/pasteimagedata",data:{dataURL:t.dataURL},success:function(n){e.parent().find(".error,.loading").fadeOut(),e.val(e.val()+' <img src="'+n.filepath+'" width="'+t.width+'" height="'+t.height+'">')},error:function(t){413===t.status&&(e.parent().find(".error,.loading").remove(),e.after('<p class="error">Image too large, maximum file size for pasted images is 2MB</p>'))}})}),document.getElementById("thread-content-input")&&document.getElementById("thread-content-input").addEventListener("drop",function(t){t.preventDefault();var e=t.dataTransfer.files[0],n=new FileReader,a=$("#thread-content-input");n.onload=function(t){var e=document.createElement("img");e.onload=function(){$.ajax({method:"post",url:"/pasteimagedata",data:{dataURL:t.target.result},success:function(t){a.parent().find(".error,.loading").fadeOut(),a.val(a.val()+' <img src="'+t.filepath+'" width="'+e.naturalWidth+'" height="'+e.naturalHeight+'">')},error:function(t){413===t.status&&(a.parent().find(".error,.loading").remove(),a.after('<p class="error">Image too large, maximum file size for pasted images is 2MB</p>'))}})},e.src=t.target.result},n.readAsDataURL(e)},!1),$("#preview-button").on("click",function(t){t.preventDefault();var e=$("#thread-content-input").val();$.post("/ajax/preview",{content:e}).then(function(t){$("#comment-preview .content").html(t.content),format_special("#comment-preview .content"),$("#comment-preview").show()})}),$("#comment-form").on("submit",function(){return 0===$("#thread-content-input").val().length?!1:($("#submit-button").attr("disabled","disabled"),hasStorage&&localStorage.removeItem(key),void this.submit())}),selected={html:null,comment_id:null},$(".content").click(function(){if(selected.html=null,selected.comment_id=null,window.getSelection){if(selObj=window.getSelection(),selObj.focusNode){for(selRange=selObj.getRangeAt(0),p=selRange.commonAncestorContainer;p.parentNode&&!$(p).hasClass("comment-container");)p=p.parentNode;p.id&&(dash=p.id.lastIndexOf("-"),-1!=dash&&(selected.comment_id=p.id.substring(dash+1),fragment=selRange.cloneContents(),e=document.createElement("b"),e.appendChild(fragment),selected.html=e.innerHTML))}}else document.selection&&document.selection.createRange&&"None"!=document.selection.type&&(selected.html=document.selection.createRange().htmlText)}),$(".censor").click(function(){$(this).children(".content").toggle()}),thread={status_text:{nsfw:["Unmark Naughty","Mark Naughty"],closed:["Open Thread","Close Thread"]},comments:[],get_comment_details:function(t,e){var n=$("#comment-"+t+" .content"),a=$("#comment-"+t+" .username a").text(),o=$(".welcome a:first").text();$.ajax({method:"get",url:"/comment/"+t,success:function(i){i&&i.content&&(thread.comments[t]={container:n,rendered:n.html(),data:{content:i.content.replace(/<br>/g,"\n").replace(/<br \/>/g,"\n"),owner:i.postedby===o&&1===$("#comment-"+t+" #thread-control").length||moment(i.created).diff(new Date)>-36e5},author:a},e())}})},quote:function(t){void 0!==thread.comments[t]?(content=selected.comment_id&&selected.comment_id!=t||!selected.html?thread.comments[t].data.content:selected.html,selected.html=null,selected.comment_id=null,html='<blockquote title="'+$.trim(thread.comments[t].author)+'">'+content+"</blockquote>",$("#thread-content-input").val($("#thread-content-input").val()+html),$(window).scrollTop($("#thread-content-input").offset().top),$("#thread-content-input").focus(),$("#thread-content-input").scrollTop($("#thread-content-input")[0].scrollHeight-$("#thread-content-input").height()),$("#thread-content-input").selectRange($("#thread-content-input").val().length)):thread.get_comment_details(t,function(){thread.quote(t)})},save:function(t){var e={comment_id:t,content:$("#comment-"+t+" .content textarea").val(),isFirst:1===$("#comment-"+t+" .user-block").length};$.ajax({method:"put",url:"/comment/"+t,data:e,success:function(e){var n=e.content;Math.floor(e.edit_percent)>0&&(n+='<div class="edited-percent">Edited '+Math.floor(e.edit_percent)+"%</div>"),format_special($("#comment-"+t+" .content").html(n)),delete thread.comments[e._id]}})},set_status:function(t,e,n,a){$.get("/ajax/set_thread_status/"+t+"/"+e+"/"+n+"/"+a,function(o){if(1===o){if("deleted"==e)return void(window.location="/");n=1==n?0:1,$("#control-"+e+" span").unbind("click").bind("click",function(){return thread.set_status(t,e,n,a),!1}).html(thread.status_text[e][n])}})},view_original:function(t){void 0!==thread.comments[t]&&$("#comment-"+t+" .content").html(thread.comments[t].rendered)},view_source:function(t){if(void 0!==thread.comments[t]){if(comment=thread.comments[t],0!==comment.container.find("textarea").length)return void thread.view_original(t);comment.container.html($("<textarea>",{id:"comment-"+t+"-source",val:comment.data.content})),comment.data.owner&&comment.container.append($("<button>",{html:"Save"}).bind("click",function(){thread.save(t)})),comment.container.append($("<button>",{html:"Close"}).bind("click",function(){thread.view_original(t)}))}else thread.get_comment_details(t,function(){thread.view_source(t)})},id:function(){return $(".favourite").attr("rel")}},$("#control-closed").click(function(){var t=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+t+"/close",success:function(){window.location.reload()}})}),$("#control-open").click(function(){var t=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+t+"/open",success:function(){window.location.reload()}})}),$("body").on("click","#control-nsfw",function(){var t=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+t+"/nsfw",success:function(){$("#control-nsfw").attr("id","control-sfw").find("span").text("Unmark Naughty")}})}),$("body").on("click","#control-sfw",function(){var t=$("input[name=threadurlname]").val();$.ajax({method:"put",url:"/thread/"+t+"/sfw",success:function(){$("#control-sfw").attr("id","control-nsfw").find("span").text("Mark Naughty")}})}),function(t){var e,n=t("input[name=threadurlname]").val(),a=t("#notifications"),o=0,i=t("title").text();n&&a.length&&window.EventSource&&(e=new EventSource("/thread/"+n+"/events"),a.on("click","#closenotify",function(t){t.preventDefault(),a.hide()}).on("click","#notify",function(t){t.preventDefault(),window.location.hash="#bottom",window.location.reload(!0)}),e.addEventListener("message",function(){o++,t("title").text([o," new posts | ",i].join("")),a.html('<a id="closenotify"></a><div id="notifier"><a id="notify" href="">'+o+" new post"+(1===o?"":"s")+" added</a></div>").show()},!1))}(jQuery);var $input=$("#thread-content-input"),$form=$input.parents("form"),key=document.title,hasStorage=function(){try{return!!localStorage.getItem}catch(t){return!1}}();0!==$input.length&&hasStorage&&(localStorage.getItem(key)&&$input.val(localStorage.getItem(key)),$input.bind("keyup change",function(){localStorage.setItem(key,$input.val())}));
function NestedQuote(t){this.$node=t,this.labels={up:"Show older",down:"Hide"},this.doNesting()}NestedQuote.prototype.doNesting=function(){var t=this.$node.find(".tquote:first");t.length&&this.applyNesting(t)},NestedQuote.prototype.makeToggle=function(t){var e=$('<a href="#" class="quote-nested-toggle"></a>').text(this.labels.up),n=this.labels;return e.click(function(i){i.preventDefault(),t.is(":hidden")?(e.text(n.down),t.show()):(e.text(n.up),t.hide())}),e},NestedQuote.prototype.skipToggle=function(t){var e=t.clone(),n=this.$node.clone();return e.add(n).find(".tqname").remove(),e.add(n).find("img").each(function(){var t=$(this);t.before("<span>"+t.attr("href")+"</span>")}),e.text()===n.text()},NestedQuote.prototype.applyNesting=function(t){if(t){if(this.skipToggle(t))return this.applyNesting(t.find(".tquote:first"));t.before(this.makeToggle(t)),t.hide()}},$(".welcome a:first").length&&$(".you").html($("<div>").append($(".welcome a:first").clone()).html()),$(function(){function t(){return"undefined"==typeof window.thread?!1:!0}function e(){var t,e=["input","textarea","button"],n=[{seq:[113,116],path:"/"},{seq:[113,112],path:"/f/participated"},{seq:[113,102],path:"/f/favorites"},{seq:[113,104],path:"/f/hidden"},{seq:[113,109],path:"/messages/inbox"},{seq:[113,117],path:"/users"}],i=[];return function(a){-1===e.indexOf(a.target.nodeName.toLowerCase())&&(i.push(a.which),i=i.slice(-2),t=_(n).find(function(t){return _(t.seq).isEqual(i)}),t&&(self.location=t.path))}}function n(t,e,n){window.location.href=t+"?x="+e+"&y="+n}var i,a=$("#title-input").html();$("#main-title.changeling").bind("click",function(){if($(this).is(":not(.editing)")){i=$.trim($("h3",this).text()),$(this).addClass("editing"),$("h3",this).empty().append(a);var t=$(this).find("#title-input");t.val(i),t[0].focus(),t[0].select()}}),$(".youtube_wrapper").on("click",function(){var t=$(this);t.data("active")||(t.data("active",!0),$(this).html('<div class="embed-container"><iframe src="http://www.youtube.com/embed/'+t.attr("id")+"?autoplay=1"+t.data("extra")+'" frameborder="0" allowfullscreen></iframe></div><br />'))}),$("body").on("click","#cancel-title",function(){$("h3","#main-title").empty().text(i),$("#main-title").removeClass("editing")}),$("body").on("click","#save-title",function(){var e=$("#title-input").val(),n="title="+encodeURIComponent(e);n+=t()?"&thread_id="+thread.id():"",$.ajax({type:"POST",url:"/title/edit",data:n,success:function(){$("h3","#main-title").empty().text(e),$("#main-title").removeClass("editing")}})}),$("#toggle-html").bind("click",function(){$.ajax({method:"put",url:"/togglehtml",success:function(){window.location.reload(!0)}})}),$(".hide-thread").bind("click",function(t){t.preventDefault(),t.stopPropagation();var e=$(this),n=e.hasClass("added"),i=e.attr("href"),a=e.data("id"),o=i.split("/"),s=o[o.length-1];$.ajax({method:"put",url:i,data:{threadid:a},success:function(){e.toggleClass("added",!n),e.parent(".five").parent(".thread").slideUp().next().slideUp(),s=e.hasClass("added")?"unhide":"hide",o[o.length-1]=s,e.attr("href",o.join("/"))}})}),$(".favourite").bind("click",function(t){t.preventDefault(),t.stopPropagation();var e=$(this),n=e.attr("href"),i=e.data("id"),a=n.split("/"),o=a[a.length-1];$.ajax({method:"put",url:n,data:{threadid:i},success:function(){e.toggleClass("added"),o=e.hasClass("added")?"unfavourite":"favourite",a[a.length-1]=o,e.attr("href",a.join("/"))}})});var o=$("#login-box").html();$("#login-form").on("submit",function(t){t.preventDefault();var e={username:$("#username").val(),password:$("#password").val()};$.ajax({url:"/login",type:"POST",data:e}).fail(function(t){$(".error").text(401===t.status?"Login incorrect":403===t.status?"Account banned":"Unknown error")}).then(function(){window.location.reload()})}),$("#forgot-password").on("click",function(t){t.preventDefault();var e=$("#login-box");$.ajax({url:"/forgot-password",success:function(t){e.html(t),e.find("form").submit(function(t){t.preventDefault();var n=$("#forgot-email").val();n&&n.length>1&&$.ajax({type:"post",url:"/forgot-password",data:{email:n},success:function(){e.html("<h5>Check your email!</h5><p>An email containing a link to reset your password has been sent to "+n+"</p>")},error:function(){e.html("<h5>Could not send email :(</h5><p>Could not send email to "+n+"</p>")}})})}})}),$("#forgot-request").on("submit",function(t){t.preventDefault();var e={email:$("#forgot-email").val(),key:$("#forgot-key").val()};$.ajax({url:"/auth/forgot_password",type:"POST",data:e}).fail(function(t){$(".error").text(JSON.parse(t.responseText).error)}).then(function(){$("#login-box").html(o),$(".error").text("Password reset email sent")})}),$("#forgot-back").on("click",function(t){t.preventDefault(),$("#login-box").html(o)}),$("#hide-ads").on("click",function(t){t.preventDefault(),$.ajax({url:"/ajax/hide_ads/"+session_id,success:function(t){1==t&&window.location.reload(!1)}})}),$("#unhide-ads").on("click",function(t){t.preventDefault(),$.ajax({url:"/ajax/show_ads/"+session_id,success:function(t){1==t&&window.location.reload(!1)}})}),$(".remove-acq, .toggle-acq").click(function(t){t.preventDefault();var e=$(this),n=$(this).parent(),i=$(this).attr("rel"),a=["ignore","buddy"],o=n.filter(".buddy-listing").length,s=e.hasClass("toggle-acq"),r=a[o];$.ajax({method:"post",url:"/buddies",data:{command:r,username:i,remove:!0},success:function(){var t=n.detach();s&&(r=a[1-o],$.ajax({method:"post",url:"/buddies",data:{command:r,username:i},success:function(){return"ignore"===r?(t.removeClass("buddy-listing").addClass("enemy-listing"),t.find(".toggle-acq").text("buddilize"),$("#enemy-listings").append(t)):(t.removeClass("enemy-listing").addClass("buddy-listing"),t.find(".toggle-acq").text("ignore"),void $("#buddy-listings").append(t))}}))}})});var s=$(".give-point, .take-point");s.click(function(t){var e=$(this),n=e.parent().find(".current-points"),i="minus"===e.data("type")?"removepoint":"addpoint",a=e.data("commentid"),o=e.data("pendinguserid"),r="/comment/"+a+"/"+i;o&&(r="/pendingusers/"+o+"/"+i),t.preventDefault(),$.ajax({method:"put",url:r,success:function(t){var e=t.points;t.pendingUsers&&(e=t.pendingUsers.points),s.css({visibility:"hidden"}),n.text(e+" point"+(1!==e?"s":""))},error:function(t){return 401===t.status?(s.css({visibility:"hidden"}),n.text("Unauth")):void n.text("Error")}})}),$("body").keypress(e());var r=$(".content > .tquote > .tquote");if(r.each(function(){new NestedQuote($(this))}),$(".buddyform").each(function(){$(this)}),$("#search-box").submit(function(t){$("#search-phrase").val().trim().length||t.preventDefault()}),$(".amazing-game").length){var d=parseInt($(".position-x").val(),10),l=parseInt($(".position-y").val(),10),u=window.location.href.split("?")[0];$(".go-north").click(function(){n(u,d,l-1)}),$(".go-south").click(function(){n(u,d,l+1)}),$(".go-west").click(function(){n(u,d-1,l)}),$(".go-east").click(function(){n(u,d+1,l)})}});
